(function() {
  ...
  var BODY_HTML = [
    ...
    '    <div class="card">',
    '      <h3>\u6b22\u8fce</h3>',
    '      <p>\u8fd9\u662f\u4f60\u7684 PicFast \u516c\u5171\u9875\u9762\u5e94\u7528\u81ea\u5b9a\u4e49 CSS \u540e\u7684\u6548\u679c\u9884\u89c8\u3002\u5728\u5de6\u4fa7\u7f16\u8f91 CSS\uff0c\u8fd9\u91cc\u4f1a\u5b9e\u65f6\u66f4\u65b0\u3002</p>',
    '      <div style="display:flex;gap:0.5rem;flex-wrap:wrap">',
    '        <button class="btn btn-primary">\u5f00\u59cb\u4f7f\u7528</button>',
    '        <button class="btn btn-secondary">\u4e86\u89e3\u66f4\u591a</button>',
    '        <button class="btn btn-outline">\u6587\u6863</button>',
    '        <button class="btn btn-destructive">\u5220\u9664</button>',
    '      </div>',
    '      <div style="display:flex;gap:0.5rem;margin-top:0.75rem"><span class="badge">\u9ed8\u8ba4</span><span class="badge success">\u6210\u529f</span><span class="badge warning">\u8b66\u544a</span></div>',
    '    </div>',
    '    <div class="console">',
    '      <h3 style="font-size:0.875rem;margin:0 0 0.75rem">\u63a7\u5236\u53f0\u89c6\u56fe</h3>',
    '      <div class="pf-console-shell">',
    '        <div class="sidebar-mock">',
    '          <div class="sidebar-item active">\u4e0a\u4f20</div>',
    '          <div class="sidebar-item">\u56fe\u7247</div>',
    '          <div class="sidebar-item">\u76f8\u518c</div>',
    '          <div class="sidebar-item">\u8bbe\u7f6e</div>',
    '        </div>',
    '        <div class="pf-console-content">',
    '          <div class="stats">',
    "            <div class=\"stat\"><div class=\"stat-value\">247</div><div class=\"stat-label\">\u56fe\u7247</div></div>",
    "            <div class=\"stat\"><div class=\"stat-value\">3.2 GB</div><div class=\"stat-label\">\u5b58\u50a8</div></div>",
    "            <div class=\"stat\"><div class=\"stat-value\">1.2k</div><div class=\"stat-label\">\u6d4f\u89c8</div></div>",
    '          </div>',
    '          <label>\u4e0a\u4f20\u533a\u57df</label>',
